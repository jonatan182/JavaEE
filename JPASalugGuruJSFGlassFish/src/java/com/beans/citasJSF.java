...
public class citasJSF {
    ...
    public Date getFechaCita() {
        try{
            DateFormat df = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss.S");//para formatear la fecha de string a date con el formato indicado dia/mes/año hora minuto segundo
